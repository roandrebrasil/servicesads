...
export default class Login extends React.Component {
  ...
  login(){
    axios.post(process.env.REACT_APP_SERVER + "/auth/authenticate", {
    ...
    return (
      <div id="containerlogin">
        <div id="box">
          ...
          <input type="email" value={this.state.email} onChange={(event) => this.setState({email: event.target.value})}></input>
          <div id="label2">
            <label>Senha</label>
          </div>
          {/* {this.state.username} */}
          ...
          {/* <button onClick={()=> this.pegarUsername()}>Entrar</button> */}
